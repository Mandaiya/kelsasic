...
from AlexaMusic.plugins.modules.blast import open_me_markup, surprise_markup, click_me_markup, close_me_markup
...
async def on_open_me_button_click(client, etho: Union[types.Message, types.CallbackQuery]):
    ...
    if user_name in etho.message.text:
        ...
        await etho.answer("Dont see others stuff 🌚")
